    ...
    <div class="admin-content">
        <div class="admin-content-body">
            ...
            <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
                <li><a href="?r=show-admin-super" class="am-text-success"><span class="am-icon-btn am-icon-user-md"></span><br/>超级管理员<br/><?php echo $super_admins_count?></a></li>
                    ...
                    <table class="am-table am-table-bd am-table-striped admin-content-table">
                        ...
                        while ( $student = mysqli_fetch_array ( $query ) ) {
                            ...
                            <tr>
                                ...
                                echo "<script>console.log('{$student['Dor_Id']}')</script>";
                                ?>
