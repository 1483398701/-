...
// 查询 当前用户的所有信息
$users_current_query = "SELECT * FROM user WHERE Id='$Id' ORDER BY Id DESC";
...
if ($as_save != "") {
    ...
    if (!isset($as_password_changing) && $as_password_changing != 'Yes') {
        mysqli_query($conn,"UPDATE user SET UserName='$as_name' WHERE Id='$as_no'") or die ('SQL语句有误：' . mysqli_error($conn));
        echo "<script>alert('信息更新成功！');location.href='?r=user-admin-super&uno=$Id'</script>";
//    echo "<script>alert('信息更新成功！');</script>";
        ...
        if ($as_password == "" && $as_password_new == "" && $as_password_repeat == "") {
            ...
            if ($as_password != queryPasswordByUno($conn,$Id)) {
            ...
            mysqli_query($conn,"UPDATE user SET UserName='$as_name' WHERE Id='$as_no'") or die ('SQL语句有误：' . mysqli_error($conn));
            mysqli_query($conn,"UPDATE user SET Password='$passMD5Temp' WHERE Id='$Id'");
        ...
        <div class="admin-content-body">
            ...
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                    <form class="am-form am-form-horizontal" method="post" name="edit" action="?r=user-admin-super&uno=<?php echo $Id?>">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="admin-name-super" name="admin-name-super" placeholder="请输入你的姓名"
                                       value="<?php echo $users_current['UserName'] ?>" <?php if ($user_power != 1) echo 'readonly="true"' ?>>
